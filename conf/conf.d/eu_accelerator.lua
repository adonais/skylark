...
function load_accels()
  ...
  if (not emod.file_exists(acc_file)) then
    local code = {
      ...
      "local FCONTROL= 0x08\n",
      "local FALT = 0x10\n",
      "-- virtualkey codes, See: https://docs.microsoft.com/en-us/windows/win32/inputdev/virtual-key-codes\n",
      "local VK_F1 = 0x70\n",
      "local VK_F2 = 0x71\n",
      "local VK_F3 = 0x72\n",
      "local VK_F4 = 0x73\n",
      ...
      "                 {bit.bor(FVIRTKEY,FCONTROL), VK_OEM_2, IDM_EDIT_LINECOMMENT},\n",
      "                 {bit.bor(FVIRTKEY,FCONTROL), VK_OEM_5, IDM_EDIT_STREAMCOMMENT},\n",
      ...
      "                 {bit.bor(FVIRTKEY,FCONTROL,FSHIFT), VK_OEM_6, IDM_SEARCH_SELECTTOP_FIRSTLINE},\n",
      "                 {bit.bor(FVIRTKEY,FCONTROL,FSHIFT), VK_OEM_4, IDM_SEARCH_SELECTBOTTOM_FIRSTLINE},\n",
      ...
      "                 -- Programming menu\n",
      "                 {bit.bor(FVIRTKEY,FALT), VK_OEM_5, IDM_SOURCE_BLOCKFOLD_TOGGLE},\n",
      "                 {bit.bor(FVIRTKEY,FALT), VK_OEM_6, IDM_SOURCE_BLOCKFOLD_CONTRACT},\n",
      "                 {bit.bor(FVIRTKEY,FALT), VK_OEM_4, IDM_SOURCE_BLOCKFOLD_EXPAND},\n",
