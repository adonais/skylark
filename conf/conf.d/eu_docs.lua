...
if (not eu_core.file_exists(user_file)) then
  ...
  local user_code = {
    ...
    "  local res = eu_core.euapi.on_doc_init_after_scilexer(pnode, 60)            -- 60, SCLEX_AU3\n",
    "  if (res ~= 1) then\n",
    ...
    "  local pnode = eu_core.ffi.cast(\"void *\", p)\n",
    "  local res = eu_core.euapi.on_doc_init_after_scilexer(pnode, 36)            -- 36, SCLEX_FORTRAN\n",
    "  if (res ~= 1) then\n",
    ...
    "  local pnode = eu_core.ffi.cast(\"void *\", p)\n",
    "  local res = eu_core.euapi.on_doc_init_after_scilexer(pnode, 133)           -- 133, SCLEX_JULIA\n",
    "  if (res ~= 1) then\n",
