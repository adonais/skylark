...
function eu_accel.loadaccel()
  ...
  if (not eu_core.file_exists(acc_file)) then
    local code = {
      ...
      "local IDM_FILE_RESTART_ADMIN = 30116\n",
      "local IDM_EXIT = 105\n",
      "-- Edit\n",
      ...
      "local IDM_DELETE_ALL_SPACE_LINEHEAD = 30449\n",
      "local IDM_DELETE_ALL_SPACE_LINETAIL = 30450\n",
      "local IDM_VIEW_SWITCH_TAB = 30451\n",
      ...
      "local IDM_EDIT_WORD_UPPERCASE = 30452\n",
      "local IDM_EDIT_SENTENCE_UPPERCASE = 30453\n",
      "local IDM_EDIT_TAB_SPACE = 42825\n",
      "local IDM_EDIT_SPACE_TAB = 42826\n",
      "local IDM_EDIT_OTHER_EDITOR = 42828\n",
      "local IDM_EDIT_OTHER_BCOMPARE = 42829\n",
      ...
      "local IDM_SEARCH_MATCHING_BRACE = 43022\n",
      "local IDM_SEARCH_MATCHING_BRACE_SELECT = 43023\n",
      ...
      "-- Format\n",
      "local IDM_FORMAT_REFORMAT_JSON = 42250\n",
      "local IDM_FORMAT_COMPRESS_JSON = 42251\n",
      "local IDM_FORMAT_REFORMAT_JS = 42254\n",
      "local IDM_FORMAT_COMPRESS_JS = 42255\n",
      ...
      "local IDM_FORMAT_FULL_HALF = 44051\n",
      "local IDM_FORMAT_HALF_FULL = 44052\n",
      ...
      "local IDM_SOURCE_SNIPPET_CONFIGURE = 44000\n",
      ...
      "                 {bit.bor(FVIRTKEY,FCONTROL), string.byte(\"E\"), IDM_DELETE_SPACE_LINETAIL},\n",
      ...
      "                 {bit.bor(FVIRTKEY,FALT), string.byte(\"H\"), IDM_FORMAT_FULL_HALF},\n",
      "                 {bit.bor(FVIRTKEY,FALT), string.byte(\"F\"), IDM_FORMAT_HALF_FULL},\n",
