...
static const int errmsg_section_size[] = { 888, 227, 488, 3659 };

static const int total_error_count = 5262;
...
static const int pfs_session_error_stat_count = 1462;

static const int pfs_global_error_stat_count = 3309;
