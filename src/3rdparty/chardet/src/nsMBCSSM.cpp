...
static uint32_t BIG5_cls [ 256 / 8 ] = {
...
static uint32_t EUCJP_cls [ 256 / 8 ] = {
...
static uint32_t EUCKR_cls [ 256 / 8 ] = {
//PCK4BITS(0,1,1,1,1,1,1,1),  // 00 - 07
...
static uint32_t EUCTW_cls [ 256 / 8 ] = {
...
static uint32_t GB18030_cls [ 256 / 8 ] = {
PCK4BITS(1,1,1,1,1,1,1,1),  // 00 - 07
PCK4BITS(1,1,1,1,1,1,0,0),  // 08 - 0f
PCK4BITS(1,1,1,1,1,1,1,1),  // 10 - 17
PCK4BITS(1,1,1,0,1,1,1,1),  // 18 - 1f
...
static uint32_t SJIS_cls [ 256 / 8 ] = {
//PCK4BITS(0,1,1,1,1,1,1,1),  // 00 - 07
PCK4BITS(1,1,1,1,1,1,1,1),  // 00 - 07
PCK4BITS(1,1,1,1,1,1,0,0),  // 08 - 0f
PCK4BITS(1,1,1,1,1,1,1,1),  // 10 - 17
...
static uint32_t UCS2BE_cls [ 256 / 8 ] = {
...
static const uint32_t UCS2BECharLenTable[] = {2, 2, 2, 0, 2, 2};
...
static uint32_t UCS2LE_cls [ 256 / 8 ] = {
PCK4BITS(0,0,0,0,0,0,0,0),  // 00 - 07
PCK4BITS(0,0,1,0,0,2,0,0),  // 08 - 0f
PCK4BITS(0,0,0,0,0,0,0,0),  // 10 - 17
PCK4BITS(0,0,0,3,0,0,0,0),  // 18 - 1f
...
static const uint32_t UCS2LECharLenTable[] = {2, 2, 2, 2, 2, 2};
...
static uint32_t UTF8_cls [ 256 / 8 ] = {
//PCK4BITS(0,1,1,1,1,1,1,1),  // 00 - 07
