...
int on_search_select_all(eu_tabpage *pnode);
int on_search_select_word(eu_tabpage *pnode);
int on_search_select_line(eu_tabpage *pnode);
int on_search_left_group(eu_tabpage *pnode);
int on_search_right_group(eu_tabpage *pnode);
int on_search_left_word(eu_tabpage *pnode);
int on_search_right_word(eu_tabpage *pnode);
int on_search_cumulative_previous_block(eu_tabpage *pnode);
int on_search_cumulative_next_block(eu_tabpage *pnode);

int on_search_move_to_lgroup(eu_tabpage *pnode);
int on_search_move_to_rgroup(eu_tabpage *pnode);
int on_search_move_to_lword(eu_tabpage *pnode);
int on_search_move_to_rword(eu_tabpage *pnode);
int on_search_move_to_top_block(eu_tabpage *pnode);
int on_search_move_to_bottom_block(eu_tabpage *pnode);
int on_search_jmp_home(eu_tabpage *pnode);
int on_search_jmp_end(eu_tabpage *pnode);
int on_search_jmp_specified_line(eu_tabpage *pnode);

int on_search_toggle_mark(eu_tabpage *pnode, sptr_t lineno);
int on_search_add_mark(eu_tabpage *pnode, sptr_t lineno);
int on_search_remove_marks_this(eu_tabpage *pnode);
int on_search_remove_marks_all(eu_tabpage *pnode);
int on_search_jmp_premark_this(eu_tabpage *pnode);
int on_search_jmp_next_mark_this(eu_tabpage *pnode);
